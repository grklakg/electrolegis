    ...
    <div class="application-window" style="display: none">
        ...
        <form class="order-form contact-form-fields" action="./send-form.php" method="POST" enctype="application/x-www-form-urlencoded">
            ...
            <input class="form-field text-regular" placeholder="Email" type="email" id="email" name="email"
                required>
            <input class="form-field text-regular" placeholder="Телефон" type="tel" id="phone" name="phone"
                required>
            <textarea class="form-field text-regular" placeholder="Текст обращения" rows="6" name="text"></textarea>
            <input class="form-button text-regular text-color-white" type="submit" value="Отправить">
        </form>
    </div>
    <div class="container">
        ...
        <div class="contact-block">
            <div class="contact-form">
                ...
                <form class="contact-form-fields" action="" method="post">
                    <input class="form-field text-regular" placeholder="Имя" type="text" id="name" name="name" required>
                    <input class="form-field text-regular" placeholder="Email" type="email" id="email" name="email"
                        required>
                    <input class="form-field text-regular" placeholder="Телефон" type="tel" id="phone" name="phone"
                        required>
